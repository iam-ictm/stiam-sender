...
public class StiamConfiguration {
	 ...
	 * file.
	 */
	protected static final String DEFAULT_CONFIG_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/aa.properties";
	protected static final String DEFAULT_ATTRIBUTENAMEMAPPER_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/attributename-mapper.properties";
	protected static final String DEFAULT_ELIGIBILITYCHECKER_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/eligibility-checker.properties";
	protected static final String DEFAULT_QUERYSENDER_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/query-sender.properties";
	protected static final String DEFAULT_PROPERTYDIRECTORY_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/property-directory.properties";
	protected static final String DEFAULT_TESTCONFIGURATION_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/aa-test.properties";
	protected static final String DEFAULT_KEYSTORE_FILEPATH = DEFAULT_CONFIG_DIR
			+ "/aa.jks";
	...
	protected static final String DEFAULT_BINDING = "soap"; // alternative:
															// http_post
	...
	private StiamConfiguration() {
		...
		if (systemProperties.getProperty("stiam.config") != null
			...
			logger.info(
					"Trying to read configuration specified by system property: {}",
					systemProperties.getProperty("stiam.config"));
	...
	public String getAttributeNameMapperFilePath() {
		return stiamSettings.getProperty("AttributeNameMapper.FilePath",
				userHome + "/" + DEFAULT_ATTRIBUTENAMEMAPPER_FILEPATH);
	}
	...
	public String getEligibilityCheckerFilePath() {
		return stiamSettings.getProperty("EligibilityChecker.FilePath",
				userHome + "/" + DEFAULT_ELIGIBILITYCHECKER_FILEPATH);
	}
	...
	public String getQuerySenderFilePath() {
		return stiamSettings.getProperty("QuerySender.FilePath", userHome + "/"
				+ DEFAULT_QUERYSENDER_FILEPATH);
	}
	...
	public String getPropertyDirectoryFilePath() {
		return stiamSettings.getProperty("PropertyDirectory.FilePath", userHome
				+ "/" + DEFAULT_PROPERTYDIRECTORY_FILEPATH);
	}
	...
	public String getTestConfigurationFilePath() {
		return stiamSettings.getProperty("TestConfiguration.FilePath", userHome
				+ "/" + DEFAULT_TESTCONFIGURATION_FILEPATH);
	}
	...
	public String getKeystoreFilePath() {
		return stiamSettings.getProperty("Keystore.FilePath", userHome + "/"
				+ DEFAULT_KEYSTORE_FILEPATH);
	}
	...
	public String getSAMLDestination() {
		return stiamSettings.getProperty("SAML.Destination",
				DEFAULT_SAML_DESTINATION);
	}
	...
	public int getSAMLAssertionValidityMinutes() {
		return Integer.parseInt(stiamSettings.getProperty(
				"SAML.AssertionValidityMinutes",
				DEFAULT_SAML_ASSERTIONVALIDITYMINUTES));
	}
	...
	public String getSAMLNameIDFormat() {
		return stiamSettings.getProperty("SAML.NameIDFormat",
				DEFAULT_SAML_NAMEIDFORMAT);
	}
	...
	public String getSAMLAssuranceLevel() {
		return stiamSettings.getProperty("SAML.AssuranceLevel",
				DEFAULT_SAML_ASSURANCELEVEL);
	}
	...
	public String getSAMLSubjectConfirmationMethod() {
		return stiamSettings.getProperty("SAML.SubjectConfirmationMethod",
				DEFAULT_SAML_SUBJECTCONFIRMATIONMETHOD);
	}
	...
	public int getLdapPort() {
		return Integer.parseInt(stiamSettings.getProperty("LdapClient.Port",
				DEFAULT_LDAP_PORT));
	}
	...
	public String getLdapPassphrase() {
		return stiamSettings.getProperty("LdapClient.Passphrase",
				DEFAULT_LDAP_PASSPHARSE);
	}
	...
	public String getLdapBaseDN() {
		return stiamSettings.getProperty("LdapClient.BaseDN",
				DEFAULT_LDAP_BASEDN);
	}
	 ...
	 *
	 * @param nameId
	 *            The nameId is used to create the filter.
	 * @return Filter used by the LDAP-Client.
	 */
	public String getLdapFilter(String nameId) {
		return String.format(stiamSettings.getProperty("LdapClient.Filter",
				DEFAULT_LDAP_FILTER), nameId);
	}
	...
	public Binding getBinding() {
		if (stiamSettings.getProperty("AttributeService.Binding",
				DEFAULT_BINDING).equalsIgnoreCase(DEFAULT_BINDING)) {
			return Binding.SOAP;
		} else {
	...
	public String getAttributeQueryEncoding() {
		return stiamSettings.getProperty(
				"AttributeService.AttributeQueryEncoding",
				DEFAULT_ATTRIBUTEQUERY_ENCODING);
	}
	...
	public boolean verifyQuerySignature() {
		return Boolean.parseBoolean(stiamSettings.getProperty(
				"AttributeService.VerifyQuerySignature",
				DEFAULT_VERIFY_QUERY_SIGNATURE));
	}
	...
	public boolean verifyAuthnStatement() {
		return Boolean.parseBoolean(stiamSettings.getProperty(
				"AttributeService.VerifyAuthnStatement",
				DEFAULT_VERIFY_AUTHN_STATEMENT));
	}
	...
	public boolean verifyAuthnSignature() {
		return Boolean.parseBoolean(stiamSettings.getProperty(
				"AttributeService.VerifyAuthnSignature",
				DEFAULT_VERIFY_AUTHN_SIGNATURE));
	}
	...
	public boolean verifyAuthnTimespan() {
		return Boolean.parseBoolean(stiamSettings.getProperty(
				"AttributeService.VerifyAuthnTimespan",
				DEFAULT_VERIFY_AUTHN_TIMESPAN));
	}
	...
	public String getKeystorePassword() {
		return stiamSettings.getProperty("Keystore.Password",
				DEFAULT_KEYSTORE_PASSWORD);
	}
	...
	public String getKeystoreEntryName() {
		return stiamSettings.getProperty("Keystore.EntryName",
				DEFAULT_KEYSTORE_ENTRY_NAME);
	}
	...
	public String getKeystoreEntryPassword() {
		return stiamSettings.getProperty("Keystore.EntryPassword",
				DEFAULT_KEYSTORE_ENTRY_PASSWORD);
	}
	 ...
	 *
	 * @param alias
	 *            The name of the entry in the keystore to load
	 ...
	 * 
	 * @param alias
	 *            the name of the certificate stored in the keystore. It should
	 *            be the same name like the issuers name.
	 * @return
	 * @throws KeyStoreException
	...
	public boolean getDefaultEligibilityPolicy() {
		return stiamSettings.getProperty("EligibilityChecker.DefaultPolicy",
				DEFAULT_ELEGIBILITY_POLICY).equalsIgnoreCase("accept");
	}
	...
	public String getDirectory() {
		return stiamSettings.getProperty("AttributeService.Directory",
				DEFAULT_DIRECTORY);
	}
	 ...
	 *
	 * @param configFile
	 *            the properties-file to load. Sets the instance-variable
